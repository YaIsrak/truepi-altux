...
export default function FeaturesSection() {
	return (
		<section className='py-[15vmin]'>
			...
			<div className='relative py-[15vmin] overflow-hidden'>
				<div className='container mx-auto px-4 lg:px-0 flex flex-col lg:flex-row items-center lg:items-stretch relative'>
					...
					<div className=' flex justify-center items-center text-left absolute top-44 z-20 mix-blend-exclusion'>
						<div className='space-y-6'>
							<div>
								<div className='flex items-start gap-4 '>
									<div className='flex  '>
										<Word
											className='text-4xl md:text-6xl xl:text-8xl font-bold font-euphoria mix-blend-exclusion uppercase'
											wordClassName=''>
											N
										</Word>
										<Word
											className='text-2xl md:text-4xl xl:text-6xl font-bold  mix-blend-exclusion uppercase'
											wordClassName=''>
											o
										</Word>
									</div>
								...
								<Word
									className='text-2xl md:text-4xl xl:text-6xl font-bold  mix-blend-exclusion uppercase'
									wordClassName='mr-5'>
									get strategies that guarantee results
								</Word>
							</div>
						</div>
					</div>
					...
					<div className='w-full lg:w-1/2 relative ml-auto mt-28 md:mt-52 '>
						...
						<div className='absolute bottom-[-2px] md:bottom-[-80px]  right-0 z-40 text-right text-2xl md:text-4xl xl:text-6xl font-bold uppercase mix-blend-exclusion'>
							<div className='flex items-center'>
								<Word className='text-4xl md:text-6xl lg:text-8xl font-euphoria'>
									M
								</Word>
								<Word
							...
							<div className='flex items-center text-right mt-2'>
								...
								<div className='flex items-center'>
									<Word className='text-4xl lg:text-6xl xl:text-8xl font-euphoria'>
										R
									</Word>
									<Word
										className='flex text-right justify-end'
